            ...
            <div class="flex flex-row items-center justify-between space-x-3 sm:flex-row sm:items-center sm:justify-between sm:space-x-0">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-3">
                        <div class="w-12 h-12 rounded-xl {{ $categorie->type == 'recette' ? 'bg-green-100 dark:bg-green-900' : 'bg-red-100 dark:bg-red-900' }} flex items-center justify-center">
                        ...
                        <div>
                            ...
                            <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 flex items-center">
                                <span class="w-2 h-2 mr-2 rounded-full {{ $categorie->is_active ? 'bg-green-400' : 'bg-red-400' }}"></span>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-5 gap-3">
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/50 dark:to-blue-800/30 p-3 rounded-lg border border-blue-200 dark:border-blue-700">
                            <div class="text-center">
                                <p class="text-xs font-semibold text-blue-700 dark:text-blue-300 uppercase tracking-wide">Total</p>
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/50 dark:to-green-800/30 p-3 rounded-lg border border-green-200 dark:border-green-700">
                            <div class="text-center">
                                <p class="text-xs font-semibold text-green-700 dark:text-green-300 uppercase tracking-wide">Ce mois</p>
                        ...
                        <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/50 dark:to-purple-800/30 p-3 rounded-lg border border-purple-200 dark:border-purple-700">
                            <div class="text-center">
                                <p class="text-xs font-semibold text-purple-700 dark:text-purple-300 uppercase tracking-wide">Transactions</p>
                        ...
                        <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-900/50 dark:to-yellow-800/30 p-3 rounded-lg border border-yellow-200 dark:border-yellow-700">
                            <div class="text-center">
                                <p class="text-xs font-semibold text-yellow-700 dark:text-yellow-300 uppercase tracking-wide">Moyenne</p>
                        ...
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600 p-3 rounded-lg border border-gray-200 dark:border-gray-500 col-span-2 sm:col-span-1">
                            <div class="text-center">
                                <p class="text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wide">Dernière</p>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div class="flex flex-col sm:flex-row gap-4 flex-1">
                            ...
                            <div class="flex gap-2">
                                <select wire:model.live="filter" class="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm">
                                    <option value="all">Toutes</option>
                                    <option value="validees">Validées</option>
                                    <option value="en_attente">En attente</option>
                                </select>
                                
                                <select wire:model.live="periode" class="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm">
                    ...
                    <div class="space-y-2">
                            ...
                            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 hover:shadow-md transition-all duration-200 cursor-pointer"
                                ...
                                <div class="sm:hidden">
                                    <div class="flex justify-between items-start mb-2">
                                        <div>
                                            <h3 class="font-medium text-gray-900 dark:text-white text-sm">{{ $transaction->description }}</h3>
                                            <p class="text-xs text-gray-500 dark:text-gray-400">{{ $transaction->reference }} • {{ $transaction->date_formattee }}</p>
                                        </div>
                                    ...
                                    @if($transaction->partenaire)
                                        <p class="text-xs text-gray-600 dark:text-gray-400">{{ $transaction->partenaire->nom }}</p>
                                    @endif
                                </div>
                                ...
                                <div class="hidden sm:grid grid-cols-12 gap-3 items-center">
                                    ...
                                    <div class="col-span-3 text-sm text-gray-900 dark:text-white">
                                        ...
                                        @if($transaction->statut === 'en_attente')
                                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300 ml-2">
                                                En attente
                                            </span>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-span-2 text-right font-medium text-sm {{ $categorie->type == 'recette' ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                                        {{ $transaction->montant_formate }}
                                    </div>
                        ...
                        @empty
                            <div class="text-center py-12">
                                ...
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Aucune transaction trouvée</p>

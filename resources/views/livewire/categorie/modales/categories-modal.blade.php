                    ...
                    <label class="flex items-center space-x-3 cursor-pointer">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400">
                                Si activée, cette catégorie sera disponible pour les nouvelles transactions.
                            </p>
                        </div>
                    </label>
                </div>
...
{{-- Modal aperçu rapide d'une catégorie --}}
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            {{ ucfirst($detail['type']) }} • {{ $detail['is_active'] ? 'Active' : 'Inactive' }}
                        </p>
                    </div>
                </div>

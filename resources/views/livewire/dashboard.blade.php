<div class="min-h-screen bg-gray-50 pt-12 sm:pt-16 pb-6 px-4 sm:px-6 lg:px-8">
    <div class="space-y-6 sm:space-y-8 max-w-7xl mx-auto">
        ...
        <div class="flex flex-col space-y-2 sm:space-y-3">
            <h1 class="text-xl sm:text-2xl font-bold text-gray-900 flex items-center gap-2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6 text-blue-600 animate-pulse"
            ...
            <p class="text-sm sm:text-base text-gray-600 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 text-green-500" fill="none"
        ...
        <div class="grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div x-data="{ openGestions: false }"
                ...
                <div class="p-4 sm:p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-100">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2 sm:gap-3">
                            <div class="p-1 sm:p-2 bg-blue-100 rounded-lg sm:rounded-xl">
                            ...
                            <h3 class="text-base sm:text-lg font-semibold text-gray-900">Gestions</h3>
                        </div>
            ...
            <div x-data="{ openFinance: false }"
                ...
                <div class="p-4 sm:p-6 bg-gradient-to-r from-green-50 to-emerald-50 border-b border-gray-100">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2 sm:gap-3">
                            <div class="p-1 sm:p-2 bg-green-100 rounded-lg sm:rounded-xl">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 text-green-600"
                                    fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                            </div>
                            <h3 class="text-base sm:text-lg font-semibold text-gray-900">Finance</h3>
                        </div>
            ...
            @if(Auth::user()->isAdmin())
                <a href="{{ route('admin.stocks') }}"
                    class="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-shadow duration-300">
                    <div class="p-4 sm:p-6 bg-gradient-to-r from-purple-50 to-violet-50 border-b border-gray-100">
                        <div class="flex items-center gap-2 sm:gap-3">
                            <div class="p-1 sm:p-2 bg-purple-100 rounded-lg sm:rounded-xl">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 text-purple-600"
                                    fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M20 7l-8-4-8 4m16 0v6l-8 4m0-10l-8 4m8 4V3m0 10l-8-4m8 4l8-4V7" />
                                </svg>
                            </div>
                            <h3 class="text-base sm:text-lg font-semibold text-gray-900">Stocks</h3>
                        </div>
                    </div>
                    <div class="p-3 sm:p-4">
                        <p class="text-xs sm:text-sm text-gray-600">Gestion des stocks et inventaires.</p>
                        <div class="mt-3 sm:mt-4 flex justify-end">
                            <span
                                class="text-xs sm:text-sm font-medium text-blue-600 hover:text-blue-800 transition">Accéder
                                →</span>
                        </div>
                    </div>
                </a>

<div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0">
            <select wire:model.live="selectedPeriod" class="rounded-lg border-gray-300 text-sm">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ number_format($stats['chiffre_affaires'], 0, ',', ' ') }}</p>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold {{ $stats['benefice_brut'] >= 0 ? 'text-green-600' : 'text-red-600' }}">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $stats['voyages_en_cours'] }}</p>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-red-600">{{ number_format($stats['factures_impayees'], 0, ',', ' ') }}</p>
                    <p class="text-xs text-gray-500">MGA</p>
                </div>
            </div>
        </div>

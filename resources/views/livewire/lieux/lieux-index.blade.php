    ...
    <div class="space-y-6 max-w-7xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">Gérez les départ, destinations et dépôts</p>
            </div>
...
<div class="grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-4">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-3 md:p-4">
        <div class="flex items-center">
            <div class="p-2 bg-blue-100 dark:bg-blue-900 dark:bg-opacity-30 rounded-lg">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-3 md:p-4">
        <div class="flex items-center">
            <div class="p-2 bg-green-100 dark:bg-green-900 dark:bg-opacity-30 rounded-lg">
                <svg class="w-5 h-5 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
            </div>
            <div class="ml-3">
                <p class="text-xs md:text-sm font-medium text-gray-600 dark:text-gray-400">Départ</p>
                <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $stats['departs'] }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-3 md:p-4">
        <div class="flex items-center">
            ...
            <div class="ml-3">
                <p class="text-xs md:text-sm font-medium text-gray-600 dark:text-gray-400">Point de chargement</p>
                <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $stats['points'] }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-3 md:p-4">
        <div class="flex items-center">
            <div class="p-2 bg-purple-100 dark:bg-purple-900 dark:bg-opacity-30 rounded-lg">
                <svg class="w-5 h-5 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/>
                </svg>
            </div>
            <div class="ml-3">
                <p class="text-xs md:text-sm font-medium text-gray-600 dark:text-gray-400">Destinations</p>
                <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $stats['destinations'] }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-3 md:p-4 col-span-2 md:col-span-1">
        <div class="flex items-center">
            <div class="p-2 bg-orange-100 dark:bg-orange-900 dark:bg-opacity-30 rounded-lg">
            ...
            <div class="ml-3">
                ...
                <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $stats['depots'] }}</p>
            </div>
        </div>
    </div>
</div>
        <!-- Recherche et filtres - Version mobile à 2 colonnes -->
<div class="bg-white dark:bg-gray-800 rounded-lg shadow">
    <div class="p-3 md:p-6">
        <div class="grid grid-cols-2 gap-2 sm:flex sm:items-center sm:justify-between sm:gap-4">
            <!-- Colonne 1: Champ de recherche -->
            ...
            <div class="col-span-1 flex items-center gap-2 sm:gap-3">
                <select wire:model.live="filterType" class="w-full bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg px-2 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 dark:text-white text-sm">
                    <option value="">Touts Types</option>
                    <option value="depot">Dépôts</option>
                    <option value="depart">Départs</option>
                    <option value="destination">Destsination</option>
                </select>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            ...
                            <th wire:click="sortBy('region')" class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600">
                                <div class="flex items center gap-1">
                            ...
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider hidden lg:table-cell">Adresse</th>
                        ...
                        @forelse($lieux as $lieu)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                <td class="px-4 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        @if($lieu->type === 'depart')
                                            <div class="p-1 bg-green-100 dark:bg-green-900 dark:bg-opacity-30 rounded mr-3">
                                                <svg class="w-4 h-4 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                                </svg>
                                            </div>
                                        @elseif($lieu->type === 'destination')
                                            <div class="p-1 bg-purple-100 dark:bg-purple-900 dark:bg-opacity-30 rounded mr-3">
                                                <svg class="w-4 h-4 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/>
                                                </svg>
                                            </div>
                                        @else
                                            <div class="p-1 bg-orange-100 dark:bg-orange-900 dark:bg-opacity-30 rounded mr-3">
                                ...
                                <td class="px-4 py-4 whitespace-nowrap hidden sm:table-cell">
                                    <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full 
                                        {{ $lieu->type === 'depart' ? 'bg-green-100 dark:bg-green-900 dark:bg-opacity-30 text-green-800 dark:text-green-400' : 
                                           ($lieu->type === 'destination' ? 'bg-purple-100 dark:bg-purple-900 dark:bg-opacity-30 text-purple-800 dark:text-purple-400' : 'bg-orange-100 dark:bg-orange-900 dark:bg-opacity-30 text-orange-800 dark:text-orange-400') }}">
                                        {{ ucfirst($lieu->type) }}
                                    </span>
                                </td>
                                ...
                                <td class="px-4 py-4 whitespace-nowrap">
                                    <button wire:click="toggleActif({{ $lieu->id }})" class="inline-flex px-2 py-1 text-xs font-semibold rounded-full 
                                        {{ $lieu->actif ? 'bg-green-100 dark:bg-green-900 dark:bg-opacity-30 text-green-800 dark:text-green-400' : 'bg-red-100 dark:bg-red-900 dark:bg-opacity-30 text-red-800 dark:text-red-400' }}">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <select wire:model="type" class="mt-1 block w-full bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:border-blue-500 text-gray-900 dark:text-white text-sm">

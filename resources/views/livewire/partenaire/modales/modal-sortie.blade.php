            ...
            <div class="p-6">
                ...
                <form wire:submit="creerSortieDepuisEntree" class="space-y-6">
                    ...
                    <div class="hidden md:block">
                        ...
                        <div class="">
                            ...
                            <div class="grid grid-cols-6 gap-3 items-end">
                                ...
                                <div class="col-span-1">
                                    <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Qté *</label>
                                    <input type="number" 
                                ...
                                {{-- Unité --}}
                                <div class="col-span-1">
                                    <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Unité</label>
                        ...
                        {{-- Liste des détails ajoutés (Desktop) --}}
                        @if(!empty($sortieDetails))
                            <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                                ...
                                {{-- En-tête tableau --}}
                                <div class="grid grid-cols-12 gap-3 mb-2 px-3 py-2 bg-gray-50 dark:bg-gray-700 rounded-lg text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase">
                                ...
                                <div class="space-y-2">
                                    @foreach($sortieDetails as $index => $detail)
                                        <div class="grid grid-cols-12 gap-3 items-center p-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg hover:shadow-md transition-all">
                    ...
                    <div class="md:hidden">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-3">
                                @if(!empty($newDetail['quantite']) && !empty($newDetail['prix_unitaire_mga']) && is_numeric($newDetail['quantite']) && is_numeric($newDetail['prix_unitaire_mga']))
                                    <div class="text-center">
                                        <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">Montant calculé</div>
                                        <div class="px-2 py-2 bg-green-100 dark:bg-green-800 text-green-800 dark:text-green-200 text-sm font-bold rounded-lg border-2 border-green-300 dark:border-green-600">
                                            {{ number_format((float)$newDetail['quantite'] * (float)$newDetail['prix_unitaire_mga'], 0, ',', ' ') }} Ar
                                        </div>
                                    </div>
                        ...
                        {{-- Liste des détails ajoutés (Mobile) --}}
                        @if(!empty($sortieDetails))
                            <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                                <h4 class="text-md font-semibold text-gray-900 dark:text-white mb-4 flex items-center">
                                    <svg class="w-5 h-5 mr-2 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    Détails ({{ count($sortieDetails) }})
                                </h4>
                                
                                <div class="space-y-3">
                                    @foreach($sortieDetails as $index => $detail)
                                        <div class="p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg">
                                ...
                                <div class="mt-4 p-4 bg-gradient-to-r from-red-50 to-red-100 dark:from-red-900 dark:from-opacity-20 dark:to-red-800 dark:to-opacity-30 rounded-lg border border-red-200 dark:border-red-700">
                                    <div class="flex justify-between items-center">
                                        <span class="font-semibold text-red-900 dark:text-red-100">TOTAL :</span>

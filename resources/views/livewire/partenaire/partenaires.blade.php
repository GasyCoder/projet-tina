        ...
        <div class="grid grid-cols-2 gap-2 mb-4">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-sm border border-gray-200 dark:border-gray-700">
                <div class="text-center">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white">{{ \App\Models\Partenaire::where('type', 'client')->count() }}</p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-sm border border-gray-200 dark:border-gray-700">
                <div class="text-center">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white">{{ \App\Models\Partenaire::where('type', 'fournisseur')->count() }}</p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg p-3 shadow-sm border border-gray-200 dark:border-gray-700">
                <div class="text-center">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white">{{ \App\Models\Partenaire::where('is_active', true)->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-3 mb-4">
            <div class="space-y-3">
                ...
                <div>
                    ...
                    <select wire:model.live="filterType" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm">
        ...
        <div class="space-y-3">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-3">
                ...
                <div class="flex items-start justify-between mb-2">
                    <div class="flex-1">
                        <h3 class="text-base font-semibold text-gray-900 dark:text-white">{{ $p->nom }}</h3>
                    </div>
                    <div class="flex flex-col items-end space-y-1">
                        ...
                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium 
                            ...
                            @else
                                <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M3 4a1 1 0 011-1h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                                </svg>
                            @endif
                            {{ ucfirst($p->type) }}
                        </span>
                        ...
                        <button wire:click="toggle({{ $p->id }})" 
                            ...
                            <span class="w-1.5 h-1.5 mr-1 rounded-full {{ $p->is_active ? 'bg-green-400' : 'bg-red-400' }}"></span>
                ...
                <div class="mb-3 space-y-1">
                    ...
                    <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <a href="tel:{{ $p->telephone }}" class="hover:text-blue-600 dark:hover:text-blue-400">{{ $p->telephone }}</a>
                    </div>
                    @endif
                    @if($p->adresse)
                    <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-sm mx-0 sm:mx-0 sm:rounded-xl overflow-hidden">
                            ...
                            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                                <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/50 dark:to-blue-800/30 rounded-lg p-4 border border-blue-200 dark:border-blue-700">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <p class="text-xs font-semibold text-blue-700 dark:text-blue-300 uppercase tracking-wide">Total Partenaires</p>
                                ...
                                <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/50 dark:to-green-800/30 rounded-lg p-4 border border-green-200 dark:border-green-700">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <p class="text-xs font-semibold text-green-700 dark:text-green-300 uppercase tracking-wide">Clients</p>
                                            <p class="text-2xl font-bold text-green-900 dark:text-green-100 mt-1">{{ \App\Models\Partenaire::where('type', 'client')->count() }}</p>
                                        </div>
                                ...
                                <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/50 dark:to-purple-800/30 rounded-lg p-4 border border-purple-200 dark:border-purple-700">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <p class="text-xs font-semibold text-purple-700 dark:text-purple-300 uppercase tracking-wide">Fournisseurs</p>
                                            <p class="text-2xl font-bold text-purple-900 dark:text-purple-100 mt-1">{{ \App\Models\Partenaire::where('type', 'fournisseur')->count() }}</p>
                                        </div>
                                ...
                                <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-900/50 dark:to-yellow-800/30 rounded-lg p-4 border border-yellow-200 dark:border-yellow-700">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <p class="text-xs font-semibold text-yellow-700 dark:text-yellow-300 uppercase tracking-wide">Partenaires Actifs</p>
                                            <p class="text-2xl font-bold text-yellow-900 dark:text-yellow-100 mt-1">{{ \App\Models\Partenaire::where('is_active', true)->count() }}</p>
                                        </div>
                        ...
                        <div class="p-3 sm:p-6 border-b border-gray-200 dark:border-gray-700">
                            <div class="flex flex-col xl:flex-row gap-4">
                                <div class="flex-1">
                                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Rechercher un partenaire</label>
                                    <div class="relative">
                                        <input type="text" 
                                               wire:model.live.debounce.300ms="search"
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-all duration-200">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-8 w-8">
                                                    <div class="h-8 w-8 rounded-lg bg-gradient-to-br {{ $p->type == 'client' ? 'from-green-400 to-green-600' : 'from-purple-400 to-purple-600' }} flex items-center justify-center">
                                                        <span class="text-sm font-bold text-white">{{ substr($p->nom, 0, 1) }}</span>
                                                    </div>
                                                </div>
                                                <div class="ml-3">
                                                    <div class="text-sm font-semibold text-gray-900 dark:text-white">{{ $p->nom }}</div>
                                                    @if($p->adresse)
                                                        <div class="text-xs text-gray-500 dark:text-gray-400">{{ Str::limit($p->adresse, 30) }}</div>
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            @if($p->telephone)
                                                <a href="tel:{{ $p->telephone }}" class="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium transition-colors">
                                                    {{ $p->telephone }}
                                                </a>
                                            @else
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <button wire:click="toggle({{ $p->id }})" 
                                                ...
                                                <span class="w-2 h-2 mr-1.5 rounded-full {{ $p->is_active ? 'bg-green-400' : 'bg-red-400' }}"></span>
                                                {{ $p->is_active ? 'Actif' : 'Inactif' }}
                                            </button>
                                        </td>
                                        <td class="px-4 py-3 whitespace-nowrap">

                    ...
                    @forelse($retours as $retour)
                        <tr class="hover:bg-orange-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                @endphp
                                <span
                                    class="px-2 py-1 text-xs font-semibold rounded-full {{ $statusClasses[$retour->statut] }}">
                ...
                <div
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <!-- Lieu de stockage -->
                            <div class="sm:col-span-3">
                                <label for="lieu_stockage_id" class="block text-sm font-medium text-gray-700">Lieu de
                                    stockage</label>
                            ...
                            <div class="sm:col-span-2">
                                <label for="quantite_kg" class="block text-sm font-medium text-gray-700">Quantité
                                    (kg)</label>
                            ...
                            <div class="sm:col-span-2">
                                <label for="quantite_sacs_pleins" class="block text-sm font-medium text-gray-700">Sacs
                                    pleins</label>
                            ...
                            <div class="sm:col-span-2">
                                <label for="quantite_sacs_demi" class="block text-sm font-medium text-gray-700">Sacs
                                    demi</label>
                            ...
                            <!-- Prix et valeur -->
                            <div class="sm:col-span-3">
                                <label for="prix_unitaire_mga" class="block text-sm font-medium text-gray-700">Prix unitaire
                                    (Ar)</label>
                            ...
                            <div class="sm:col-span-6">
                                <label for="motif_retour" class="block text-sm font-medium text-gray-700">Motif du
                                    retour</label>

...
<div x-data="{ darkMode: $persist(false) }" :class="{ 'dark': darkMode }">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="flex items-baseline">
                                <div class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $ventesJour ?? '12' }}</div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-lg border-l-4 border-purple-500 dark:border-purple-600">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">CA Mensuel</dt>
                            <dd class="flex items-baseline">
                                <div class="text-2xl font-semibold text-gray-900 dark:text-white">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:space-x-4">
                        ...
                        <div class="mt-3 sm:mt-0 flex space-x-3">
                            <select wire:model.live="filterPeriod"
                                class="block w-full pl-3 pr-10 py-3 text-base border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-lg bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200">
        ...
        <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <select wire:model.live="perPage" class="border border-gray-300 dark:border-gray-700 rounded-md text-sm py-1 px-2 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                @if(($vente['reste'] ?? $vente->reste_mga ?? 0) > 0)
                                    <div class="text-sm text-red-600 dark:text-red-400">Reste:
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ number_format($pourcentage, 0) }}%</div>
                                </div>
                            </td>
                        </tr>
                    @empty
        ...
        <div class="bg-white dark:bg-gray-800 px-6 py-4 flex items-center justify-between border-t border-gray-200 dark:border-gray-700">
            <div class="flex-1 flex justify-between sm:hidden">
                <button wire:click="previousPage" {{ ($ventes->currentPage() ?? 1) <= 1 ? 'disabled' : '' }}
                    class="relative inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-700 text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:bg-gray-100 dark:disabled:bg-gray-900 disabled:text-gray-400 dark:disabled:text-gray-500">
                    Précédent
                </button>
    ...
    {{-- Modal dynamique pour les ventes --}}

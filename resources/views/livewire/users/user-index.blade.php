        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-3 md:gap-4">
            ...
            <div class="bg-white rounded-lg shadow p-3 md:p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-xs md:text-sm font-medium text-gray-600">Chauffeurs</p>
            ...
            <div class="bg-white rounded-lg shadow p-3 md:p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-xs md:text-sm font-medium text-gray-600">Propriétaires</p>
            ...
            <div class="bg-white rounded-lg shadow p-3 md:p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-xs md:text-sm font-medium text-gray-600">Pointeurs</p>
            ...
            <div class="bg-white rounded-lg shadow p-3 md:p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-xs md:text-sm font-medium text-gray-600">Clients</p>
            ...
            <div class="bg-white rounded-lg shadow p-3 md:p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-xs md:text-sm font-medium text-gray-600">Chargeurs</p>
            ...
            <div class="bg-white rounded-lg shadow p-3 md:p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-xs md:text-sm font-medium text-gray-600">Admins</p>
            ...
            <div class="p-4 md:p-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <select wire:model.live="filterActif" class="border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th wire:click="sortBy('name')" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100">
                            ...
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden sm:table-cell">Code</th>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            @if($user->adresse)
                                                <div class="text-xs text-gray-500 sm:hidden">{{ Str::limit($user->adresse, 20) }}</div>
                                            @endif
                                ...
                                <td class="px-4 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        <button wire:click="edit({{ $user->id }})" class="text-blue-600 hover:text-blue-900" title="Modifier">
